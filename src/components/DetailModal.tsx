  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex max-h-[92vh] w-full max-w-4xl flex-col overflow-hidden rounded-t-3xl border border-ctp-border bg-ctp-surface shadow-2xl animate-fade-in sm:mx-4 sm:rounded-3xl">
        {/* Always-visible close above the hero crop (mobile-critical) */}
        <button
          type="button"
          onClick={onClose}
          aria-label="Close"
          className="absolute right-3 top-3 z-30 inline-flex h-11 w-11 items-center justify-center rounded-full border border-white/20 bg-black/70 text-white shadow-lg backdrop-blur-md transition hover:bg-black/85"
        >
        ...
        <div className="grid max-h-[92vh] overflow-y-auto md:grid-cols-2 md:overflow-hidden">
          ...
          <div className="flex flex-col">
            ...
            <div
              className="sticky bottom-0 z-20 border-t border-ctp-border/70 bg-ctp-surface/95 p-4 backdrop-blur-md sm:hidden"
